...
const Button = () => {
  return (
    <div
      className="flex h-screen w-full flex-wrap items-center justify-center gap-x-5 bg-neutral-950 p-5"
      style={{
        backgroundImage:
    ...
    >
      <motion.button
        ...
        className="group relative rounded-xl bg-black px-12 py-4 text-3xl font-bold text-gray-500"
      >
        PRASHANT
